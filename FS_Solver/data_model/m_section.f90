...
module m_section
    ...
    private
    public t_section, new_section, CPS, CPE, CAX, C3D, ERROR_UNDEFINED_SECTION_TYPE
    
    ! available section types
    integer, parameter :: CPS = 101, & ! 2D continuum (solid) plane stress
                          CPE = 102, & ! 2D continuum (solid) plane strain
                          CAX = 103, & ! 2D continuum (solid) axisymmetric
                          C3D = 104    ! 3D continuum (solid) general case
