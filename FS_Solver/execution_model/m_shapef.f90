...
module m_shapef
    ...
    private
    public eval_functs, eval_derivs, extrapolation_matrix
    ...
    type(t_matrix) function eval_functs(element, i_ip, no_imat) result(N)
        ! procedure arguments
        type(t_element),   intent(in) :: element ! finite element
        integer,           intent(in) :: i_ip    ! integration point index
        logical, optional, intent(in) :: no_imat ! no interpolation matrix (shape functions only)
        ...
        select case (element%t_element)
            case (E2D3)
                ...
                N2 = r
                N3 = s
                if (present(no_imat).and.no_imat) then
                    N = new_matrix(1, 3)
                    N%at(1, :) = [N1, N2, N3]
                else
                    N = new_matrix(2, 6)
            ...
            case (E3D8)
                ...
                if (present(no_imat).and.no_imat) then
                    N = new_matrix(1, 8)
                    N%at(1, :) = [N1, N2, N3, N4, N5, N6, N7, N8]
                else
                    N = new_matrix(3, 24)
    ...
    ! Description:
    ! Returns the extrapolation matrix.
    type(t_matrix) function extrapolation_matrix(element) result(E)
        ! procedure arguments
        type(t_element), intent(in) :: element ! finite element
        
        ! return matrix based on element type
        select case (element%t_element)
            case (E2D3)
                E = new_matrix(3, 1)
                E%at(1, :) = [1.0]
            ...
            case (E2D4)
                E = new_matrix(4, 4)
                E%at(1, :) = [+1.866025403784439, -0.500000000000000, +0.133974596215561, -0.500000000000000]
                E%at(2, :) = [-0.500000000000000, +1.866025403784439, -0.500000000000000, +0.133974596215561]
                E%at(3, :) = [+0.133974596215561, -0.500000000000000, +1.866025403784439, -0.500000000000000]
                E%at(4, :) = [-0.500000000000000, +0.133974596215561, -0.500000000000000, +1.866025403784439]
            case (E3D4)
                E = new_matrix(4, 1)
                E%at(1, :) = [1.0]
                E%at(2, :) = [1.0]
            ...
            case (E3D5)
                E = new_matrix(5, 5)
                E%at(1, :) = [+2.175924028528766, -0.517725138781605, +0.175924028528766, -0.517725138781605, -0.316397779494322]
                E%at(2, :) = [-0.517725138781605, +2.175924028528766, -0.517725138781605, +0.175924028528766, -0.316397779494322]
                E%at(3, :) = [+0.175924028528766, -0.517725138781605, +2.175924028528766, -0.517725138781605, -0.316397779494322]
                E%at(4, :) = [-0.517725138781605, +0.175924028528766, -0.517725138781605, +2.175924028528766, -0.316397779494322]
                E%at(5, :) = [-0.187298334620742, -0.187298334620742, -0.187298334620742, -0.187298334620742, +1.749193338482967]
            case (E3D6)
                E = new_matrix(6, 6)
                E%at(1, :) = [+1.366025403784439, -1.366025403784439, +1.366025403784439, -0.366025403784439, +0.366025403784439, -0.366025403784439]
                E%at(2, :) = [+1.366025403784439, +1.366025403784439, -1.366025403784439, -0.366025403784439, -0.366025403784439, +0.366025403784439]
                E%at(3, :) = [-1.366025403784439, +1.366025403784439, +1.366025403784439, +0.366025403784439, -0.366025403784439, -0.366025403784439]
                E%at(4, :) = [-0.366025403784439, +0.366025403784439, -0.366025403784439, +1.366025403784439, -1.366025403784439, +1.366025403784439]
                E%at(5, :) = [-0.366025403784439, -0.366025403784439, +0.366025403784439, +1.366025403784439, +1.366025403784439, -1.366025403784439]
                E%at(6, :) = [+0.366025403784439, -0.366025403784439, -0.366025403784439, -1.366025403784439, +1.366025403784439, +1.366025403784439]
            case (E3D8)
                E = new_matrix(8, 8)
                E%at(1, :) = [+2.549038105676658, -0.683012701892219, +0.183012701892219, -0.683012701892219, -0.683012701892219, +0.183012701892219, -0.049038105676658, +0.183012701892219]
                E%at(2, :) = [-0.683012701892219, +2.549038105676658, -0.683012701892219, +0.183012701892219, +0.183012701892219, -0.683012701892219, +0.183012701892219, -0.049038105676658]
                E%at(3, :) = [+0.183012701892219, -0.683012701892219, +2.549038105676658, -0.683012701892219, -0.049038105676658, +0.183012701892219, -0.683012701892219, +0.183012701892219]
                E%at(4, :) = [-0.683012701892219, +0.183012701892219, -0.683012701892219, +2.549038105676658, +0.183012701892219, -0.049038105676658, +0.183012701892219, -0.683012701892219]
                E%at(5, :) = [-0.683012701892219, +0.183012701892219, -0.049038105676658, +0.183012701892219, +2.549038105676658, -0.683012701892219, +0.183012701892219, -0.683012701892219]
                E%at(6, :) = [+0.183012701892219, -0.683012701892219, +0.183012701892219, -0.049038105676658, -0.683012701892219, +2.549038105676658, -0.683012701892219, +0.183012701892219]
                E%at(7, :) = [-0.049038105676658, +0.183012701892219, -0.683012701892219, +0.183012701892219, +0.183012701892219, -0.683012701892219, +2.549038105676658, -0.683012701892219]
                E%at(8, :) = [+0.183012701892219, -0.049038105676658, +0.183012701892219, -0.683012701892219, -0.683012701892219, +0.183012701892219, -0.683012701892219, +2.549038105676658]
            case default
                error stop ERROR_UNDEFINED_ELEMENT_TYPE
        end select
    end function
