...
from application.aboutDialog import AboutDialogShell
...
#       '_optionsCommonDialog', '_optionsResultDialog', '_menuBarDebug', '_menuBarDebugTraceback', '_menuBarQuery',
#       '_menuBarQueryMesh', '_aboutDialog', '_menuBarHelp', '_menuBarHelpAbout'
#   )
    ...
    def __init__(self) -> None:
        ...
        self._icons: dict[str, QIcon] = {
            x: QIcon(f'./resources/images/{x}.svg') for x in (
                ...
                'interaction-style-ruler', 'query', 'help-about'
            )
        }

        # main window (self)
        self.setWindowTitle('FeaSoft')
        self.setWindowIcon(QIcon('./resources/icons/FeaSoft.ico'))
        ...
        # menu bar > query
        self._menuBarQuery: QMenu = QMenu(self._menuBar)
        self._menuBarQuery.setTitle('Query')
        self._menuBar.addAction(self._menuBarQuery.menuAction())

        # menu bar > query > mesh
        self._menuBarQueryMesh: QAction = QAction(self._menuBarQuery)
        self._menuBarQueryMesh.setText('Mesh')
        self._menuBarQueryMesh.setIcon(self._icons['query'])
        self._menuBarQuery.addAction(self._menuBarQueryMesh) # type: ignore

        # menu bar > debug
        self._menuBarDebug: QMenu = QMenu(self._menuBar)
        self._menuBarDebug.setTitle('Debug')
        self._menuBar.addAction(self._menuBarDebug.menuAction())

        # menu bar > debug > traceback
        self._menuBarDebugTraceback: QAction = QAction(self._menuBarDebug)
        self._menuBarDebugTraceback.setText('Traceback')
        self._menuBarDebugTraceback.setCheckable(True)
        self._menuBarDebug.addAction(self._menuBarDebugTraceback) # type: ignore

        # menu bar > help
        self._menuBarHelp: QMenu = QMenu(self._menuBar)
        self._menuBarHelp.setTitle('Help')
        self._menuBar.addAction(self._menuBarHelp.menuAction())

        # menu bar > help > about
        self._menuBarHelpAbout: QAction = QAction(self._menuBarHelp)
        self._menuBarHelpAbout.setText('About')
        self._menuBarHelpAbout.setIcon(self._icons['help-about'])
        self._menuBarHelp.addAction(self._menuBarHelpAbout) # type: ignore
        ...
        self._aboutDialog: AboutDialogShell = AboutDialogShell(self)
