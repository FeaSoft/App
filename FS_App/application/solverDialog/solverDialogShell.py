...
from PySide6.QtWidgets import (
    QWidget, QDialog, QGridLayout, QHBoxLayout, QVBoxLayout, QGroupBox, QLabel, QLineEdit, QRadioButton, QFrame,
    QSizePolicy, QPushButton, QPlainTextEdit, QSpinBox
)
...
#   )
    ...
    def __init__(self, parent: QWidget | None = None) -> None:
        ...
        # eigenvalues box
        self._eigenvaluesBox: QSpinBox = QSpinBox(self._eigenvaluesGroupBox)
        self._eigenvaluesBox.setMinimum(1)
        self._eigenvaluesBox.setMaximum(100)
        self._eigenvaluesBox.setSingleStep(1)
        self._eigenvaluesBox.setValue(10)
